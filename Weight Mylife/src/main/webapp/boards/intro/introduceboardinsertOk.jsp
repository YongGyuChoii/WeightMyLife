...
<%
	...
	try{
		...
		String sql = "insert into board(bidx,subject,writer,content,midx,fileName,fileRealName,boardtype) values(bidx_seq.nextval,?,?,?,?,?,?,'introduce')";
		...
		response.sendRedirect("introduceboardlist.jsp");
