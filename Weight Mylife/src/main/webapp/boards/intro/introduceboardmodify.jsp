...
<body>
	<div id="wrap">
		...
		<section>
			...
			<form class="modify" name="modify" action="introduceboardmodifyOk.jsp" method="post">
				...
				<div class="btnArea">
					<button type="button" class="btn btn-info" onclick="location.href='introduceboardview.jsp?bidx=<%=bidx%>&searchType=<%=searchType%>&searchValue=<%=searchValue%>'">취소</button>
