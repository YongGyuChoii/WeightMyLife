...
<body>
	<div id="wrap">
		...
		<section>
			...
			<form class="modify" name="modify" action="qandaboardmodifyOk.jsp" method="post">
				...
				<div class="btnArea">
					<button type="button" class="btn btn-info" onclick="location.href='qandaboardview.jsp?bidx=<%=bidx%>&searchType=<%=searchType%>&searchValue=<%=searchValue%>'">취소</button>
