...
<body>
	<div id="wrap">
		...
		<section>
			...
			<form class="insert" name="insert" action="freeboardinsertOk.jsp" method="post" enctype="multipart/form-data">
				...
				<div class="btnArea">
					...
					<button type="button" class="btn btn-info" onclick="location.href='freeboardlist.jsp?searchType=<%=searchType%>&searchValue=<%=searchValue%>'">취소</button>
				</div>
			</form>
