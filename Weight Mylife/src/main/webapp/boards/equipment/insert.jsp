...
<%
	...
	String esubject = multipartRequest.getParameter("esubject");
	String url = multipartRequest.getParameter("url");
	String econtent = multipartRequest.getParameter("econtent");
	...
	try{
		...
		String sql = "insert into equipmentboard(ebidx,esubject,econtent,ewriter,midx,efilename,efilerealname,url) "+
				"values(ebidx_seq.nextval,?,?,?,?,?,?,?)";
		psmt = conn.prepareStatement(sql);
		
		psmt.setString(1,esubject);
		psmt.setString(2,econtent);
		psmt.setString(3,login.getMembername());
		...
		response.sendRedirect("equipmentboardlist.jsp");
